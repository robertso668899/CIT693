<template>
<div class="content box6" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230310/f4e3b5d5a0d1457a80333a0be3b1b476.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	<!-- 标题 -->
	<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230310/5beae75884e0475ab73683a4df317f47.gif) no-repeat center top / 100% 100%","width":"100%","lineHeight":"80px","fontSize":"28px","height":"105px"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- 时间 -->
	<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"54px","fontSize":"16px","position":"absolute","right":"3%","height":"64px"}' class="times">{{ dates }}</div>
	<!-- 系统简介 -->
	<div v-if="systemIntroductionDetail" :style='{"padding":"10px","margin":"0 1% 20px 3%","borderColor":"#00a8ec","flexWrap":"wrap","background":"rgba(255,255,255,.1)","borderWidth":"2px","display":"flex","width":"25%","borderStyle":"solid","height":"300px"}'>
		<el-carousel :style='{"width":"50%","margin":"0 auto","height":"260px"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="260px" :autoplay="true" :interval="3000" :loop="true">
		...
		<div :style='{"margin":"0 0 0 20px","overflow":"hidden","color":"#fff","flex":1,"lineHeight":"24px","fontSize":"14px","textIndent":"2em","height":"268px"}' v-html="systemIntroductionDetail.content"></div>
	</div>
	<!-- 统计 -->
	<div :style='{"alignContent":"space-around","padding":"20px 10px","margin":"0 1% 30px 0%","borderColor":"#00a8ec","alignItems":"flex-start","flexWrap":"wrap","background":"rgba(255,255,255,.1)","borderWidth":"2px 0","display":"block","width":"20%","borderStyle":"solid","height":"300px"}'>

		<div :style='{"width":"100%","margin":"0 0 20px","alignItems":"center","background":"#fb8823","justifyContent":"center","display":"flex"}'>
			<div :style='{"width":"32px","background":"#fb8823","display":"none","height":"32px"}'></div>
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"14px","color":"#fff","height":"32px"}'>房产信息总数</div>
				<div :style='{"lineHeight":"32px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{xinfangxinxiCount}}</div>
			</div>
		</div>
	...
	<div class="tables">
		<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,.1)","width":"100%","lineHeight":"64px","fontSize":"28px","height":"64px"}'>房产信息</div>
        <el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#666","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
          <el-table-column :resizable="true" :sortable="false" prop="loupanming" label="楼盘名"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="false" prop="junjia" label="均价"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="false" prop="jzmj" label="建筑面积"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="false" prop="huxing" label="户型"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="false" prop="biaoqian" label="标签"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="false" prop="dizhi" label="地址"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="false" prop="fengmian" label="封面">
            ...
            <div class="echarts1">
                <div id="xinfangxinxiChart1" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts2">
                <div id="xinfangxinxiChart2" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts3">
                <div id="xinfangxinxiChart3" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts4">
                <div id="xinfangxinxiChart4" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts5">
                <div id="xinfangxinxiChart5" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts6">
                <div id="xinfangxinxiChart6" style="width:100%;height:100%;"></div>
            </div>
</div>
...
export default {
	data() {
		return {
			...
			pie: {"backgroundColor":"transparent","yAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":15,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#ccc","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(250,250,250,0.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"xAxis":{"axisLabel":{"borderType":"solid","rotate":0,"padding":0,"shadowOffsetX":0,"margin":4,"backgroundColor":"transparent","borderColor":"#000","shadowOffsetY":0,"color":"#fff","shadowBlur":0,"show":true,"inside":false,"ellipsis":"...","overflow":"none","borderRadius":0,"borderWidth":0,"width":"","fontSize":12,"lineHeight":24,"shadowColor":"transparent","fontWeight":"normal","height":""},"axisTick":{"show":true,"length":5,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"inside":false},"splitLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":false},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"cap":"butt","color":"#fff","shadowBlur":0,"width":1,"type":"solid","opacity":1,"shadowColor":"rgba(0,0,0,.5)"},"show":true},"splitArea":{"show":false,"areaStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"rgba(255,255,255,.3)","opacity":1,"shadowBlur":10,"shadowColor":"rgba(0,0,0,.5)"}}},"color":["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"legend":{"padding":0,"itemGap":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":12,"show":true,"icon":"roundRect","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"20%","borderWidth":0,"width":"80%","itemWidth":18,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":14,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"grid":{"left":"100","containLabel":true},"series":{"symbol":"emptyCircle","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"#fff","shadowOffsetY":0,"color":"","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"#000"},"showSymbol":true,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"","shadowBlur":0,"width":2,"type":"solid","opacity":1,"shadowColor":"#000"},"symbolSize":4},"title":{"borderType":"solid","padding":0,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":true,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":14,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"}},
			myChart0: null,
			boardDataList: [],
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, xinfangxinxiChart3)
...
//统计接口6
    xinfangxinxiChat6() {
      this.$nextTick(()=>{
        ...
        var xinfangxinxiChart6 = echarts.init(document.getElementById("xinfangxinxiChart6"),'macarons');
        this.$http({
            url: "xinfangxinxi/group/dizhi",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                xinfangxinxiChart6.setOption(option);
				
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, xinfangxinxiChart6)

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    xinfangxinxiChart6.resize();
                };
            }
        });
      })
...
<style lang="scss" scoped>
	...
	.box6 .tables {
				...
				margin: 0 3% 40px 3%;
				overflow: hidden;
				background: url(http://codegen.caihongy.cn/20230310/1f6bd91669f741d3bcdf94cf0489df5d.gif) no-repeat center top / 100% 100%;
				width: 94%;
				transition: 0.3s;
				height: auto;
				order: 31;
